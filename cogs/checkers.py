...
# Update History
# ..............................................................................
# 02 May 2024 - v1.3.1; Reworked help message import. Added error handling. -YY
# 17 Apr 2022 - v1.3; Removed buggy winner message. Centralized help messages to
#               one importable file. -YY
# 02 Jun 2021 - v1.2; Added support for inactivity timer of sessions. -YY
# 26 May 2021 - v1.1; Hastily rewrote some code to make parts of it extend base
#               classes. -YY
# 22 May 2021 - v1.0; File finished. -RK
#===============================================================================
# Notes
# ..............................................................................
# - Extend more base classes and clean up code. -YY
#===============================================================================
# Description
# ..............................................................................
...
class CheckersCog(Game):
    ...
    async def checkers(self, ctx, *args):
        try:
            await send_help(ctx.channel.send, "checkers")
...
async def setup(client):
    await client.add_cog(CheckersCog(client))
