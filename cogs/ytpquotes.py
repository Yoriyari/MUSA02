...
class YTPQuotes(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if "hillary how did you know that" in msg:
            await message.channel.send("> Hillary has left the server.")
        ...
        if "are you free for dinner tonight" in msg or "are ya free for dinner tonight" in msg:
            await message.channel.send("My father just got an erection.")
        ...
        if "this is a black thing isn't it" in msg or "this is a black thing isnt it" in msg:
        ...
        if "let's have sex" in msg or "lets have sex" in msg:
            await message.channel.send("Philip Banks Philips Banks-- What are you doing?")
...
def setup(client):
    client.add_cog(YTPQuotes(client))
